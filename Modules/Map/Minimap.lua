...
function xUI_Minimap()
    -- Get out of hear blob rings!
    Minimap:SetArchBlobRingScalar(0)
    Minimap:SetQuestBlobRingScalar(0)

    --MinimapCluster
    MinimapCluster:SetScale(L.cfg.minimap.scale)
    MinimapCluster:ClearAllPoints()
    MinimapCluster:SetPoint(unpack(L.cfg.minimap.point))

    -- Resize the Minimap:
    Minimap:SetMaskTexture(L.cfg.minimap.mask)
    ...
    MiniMapMailIcon:SetTexture("Interface\\Addons\\XervishUI\\Media\\Mail\\MailOrange.tga")
    ...
    GameTimeFrame:SetPoint("TOPRIGHT",Minimap,-15,-15)
    ...
    XervishUI:RegisterCallback("PLAYER_ENTERING_WORLD", Hide)
    Hide(Minimap)
end

XervishUI:RegisterCallback("PLAYER_LOGIN", xUI_Minimap)